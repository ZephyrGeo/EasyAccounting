  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav: cn(
          "flex items-center gap-1 w-full absolute top-0 inset-x-0 justify-between px-0.5",
        ...
        caption_label: cn(
          ...
          captionLayout === "label"
            ? ""
            : "rounded-md pl-2 pr-1 flex items-center gap-1 h-7 [&>svg]:text-muted-foreground [&>svg]:size-3",
          defaultClassNames.caption_label,
        ),
        table: "w-full border-collapse",
        weekdays: cn("grid grid-cols-7", defaultClassNames.weekdays),
        weekday: cn(
          "text-muted-foreground rounded-md flex-1 font-normal text-[0.7rem] select-none text-center",
          defaultClassNames.weekday,
        ),
        week: cn("grid grid-cols-7 w-full mt-1", defaultClassNames.week),
        week_number_header: cn("select-none w-(--cell-size)", defaultClassNames.week_number_header),
        week_number: cn("text-[0.7rem] select-none text-muted-foreground", defaultClassNames.week_number),
        ...
        outside: cn("text-muted-foreground opacity-30 aria-selected:text-muted-foreground", defaultClassNames.outside),
...
function CalendarDayButton({ className, day, modifiers, ...props }: React.ComponentProps<typeof DayButton>) {
  ...
  return (
    <Button
      ...
      className={cn(
        "text-xs flex aspect-square size-auto w-full min-w-(--cell-size) flex-col gap-1 leading-none font-normal",
