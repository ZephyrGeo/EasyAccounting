...
export default function AlertCard({
  ...
  return (
    <div className="bg-gradient-to-br from-indigo-500 to-purple-600 dark:from-indigo-600 dark:to-purple-700 p-6 rounded-3xl text-white shadow-lg shadow-indigo-200 dark:shadow-indigo-900/50">
      <div className="flex justify-between items-start mb-4">
        <div className="bg-white/20 dark:bg-white/30 p-2 rounded-lg backdrop-blur-sm">
          <Zap className="w-5 h-5 text-white" />
        </div>
        <span className="text-xs bg-white/20 dark:bg-white/30 px-2 py-1 rounded backdrop-blur-sm">Alert</span>
      </div>
