    ...
    <div className="group border-b border-[#F0F0EA] last:border-0">
      ...
      >
        <div className="flex items-center gap-5 flex-1">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-[14px] font-medium text-[#1A1A1A] truncate">{transaction.merchant.name}</h4>
        ...
        <div className="text-right ml-4 flex items-center gap-4">
          <div>
            <p
              className={`text-[15px] font-medium tabular-nums font-serif ${displayAmount < 0 ? "text-[#059669]" : "text-[#1A1A1A]"}`}
            >
              {displayAmount < 0 ? "+" : ""}
